...
import com.example.backend.Service.DataTestService;
...
public class DataResorce {
    private final DataTestService service;

    public DataResorce(DataTestService service) {
    ...
    public List<Data> generateData(@RequestBody List<String> prompts) {
        ...
        return service.createData(prompts);
    }
     @GetMapping
